...
public class DMLService {
    ...
    final String INSERT_SQL = "INSERT INTO PERSON ( NAME, TEMP, HOUR, MIN, ABROAD_VISIT, REG_DATE) VALUES ( ?,?,?,?,?,?)";
    final String UPDATE_SQL = "UPDATE PERSON SET NAME = ?, TEMP = ?, HOUR = ?, MIN = ?, ABROAD_VISIT = ? WHERE ID = ?";
    ...
    public int insertPerson(HashMap<String, Object> dataMap) throws SQLException {
        ...
        try {
            ...
            pstmt.setObject(2, dataMap.get("TEMP"));
            pstmt.setObject(3, dataMap.get("HOUR"));
            pstmt.setObject(4, dataMap.get("MIN"));
            pstmt.setObject(5, dataMap.get("ABROAD_VISIT"));
    ...
    public int updatePerson(Map<String, Object> updateMap) throws SQLException {
        ...
        try {
            ...
            pstmt.setObject(2, updateMap.get("TEMP"));
            pstmt.setObject(3, updateMap.get("HOUR"));
            pstmt.setObject(4, updateMap.get("MIN"));
            pstmt.setObject(5, updateMap.get("ABROAD_VISIT"));
